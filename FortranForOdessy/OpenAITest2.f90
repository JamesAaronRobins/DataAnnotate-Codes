...
program dihedral_force
   ...
   write(*,'(a,4(3f12.6))') "  F1,F2,F3,F4 (x,y,z) / kcal mol-1 Å-1:", f1, f2, f3, f4
   write(*,'(a,3f12.6)')      "  ∑F (should be ≈0):", f1+f2+f3+f4
   write(*,'(a)')              " "
   write(*,'(a)')              "  Scalar (ΣFx+Fy+Fz) forces per bead:"
   write(*,'(f10.5,2x,f10.5,2x,f10.5,2x,f10.5)') scalar
   !--- JSON block -------------------------------------------------------------
